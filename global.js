...
switch(pg_id){
	case 1:
	content='<link rel="stylesheet" type="text/css" href="slide1/slide1.css" media="screen"/><div class="s1"><img src="slide1/s1.png" width="1080" height="810" alt=""/></div><div class="s2w"><div class="s2"><img src="slide1/s2.png"/></div></div><div class="s3"><img src="slide1/s3.png"/></div><div class="s4w"><div class="s4"><img src="slide1/s4.png"/></div></div><div class="s5w"><div class="s5"><img src="slide1/s5.png"/></div><div id="counterCircle" class="circle">78</div><div id="textUp" class="textUp">HEART RATE</div><div id="textDown" class="textDown">BPM<sup>1</sup></div></div>';
	break;
	case 2:
	content='<link rel="stylesheet" type="text/css" href="slide2/slide2.css" media="screen"/><div class="s1"><img src="slide2/s1.png" width="1080" height="810" alt=""/></div><div class="s2w"><div class="s2"><img src="slide2/s2.png"/></div></div><div class="s3"><img src="slide2/s3.png"/></div><div class="s4w"><div class="s4"><img src="slide2/s4.png"/></div></div><div class="s5w"><div class="s5"><img src="slide2/s5.png"/></div><div id="counterCircle" class="circle">78</div><div id="textUp" class="textUp">HEART RATE</div><div id="textDown" class="textDown">BPM<sup>1</sup></div></div><div class="s6"><img src="slide2/s6.png"/></div><div class="s7"><img src="slide2/s7.png"/></div><div class="s8"><img src="slide2/s8.gif"/></div><div class="s9"><img src="slide2/s9.png"/></div><div class="s10"><img src="slide2/s10.png"/></div><div class="s11"><img src="slide2/s11.png"/></div><div class="s12"><img src="slide2/s12.png"/></div><div class="s13w"><div class="s13"><img src="slide2/s13.png"/></div></div><script>runAnimation();</script>';
	break;
	case 3:
	content='<link rel="stylesheet" type="text/css" href="slide3/slide3.css" media="screen"/><div class="s1"><img src="slide3/1.jpg" width="1080" height="810" alt=""></div><div class="hit_1"><img src="slide3/1.png" width="1080" height="810" alt=""/></div><div class="hit_pop1" onclick="hit_pop1()"></div><div class="hit_2"><img src="slide3/2.png" width="1080" height="810" alt=""/></div><div class="hit_pop2" onclick="hit_pop2()"></div><div class="hit_3"><img src="slide3/3.png" width="1080" height="810" alt=""/></div><div class="hit_pop3" onclick="hit_pop3()"></div><div class="hit_close1" onclick="hit_close1()"></div><div class="takeCover" onclick="takeCover();"></div>';
	break;
}
